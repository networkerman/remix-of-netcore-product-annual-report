      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="group relative w-full p-6 md:p-8 rounded-2xl bg-cream-50 border-2 border-amber-400/60 flex flex-col md:flex-row items-center gap-6 md:gap-10 overflow-hidden animate-border-shimmer"
          >
