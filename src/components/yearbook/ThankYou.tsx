  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-gradient-radial from-violet-300/20 via-transparent to-transparent blur-3xl pointer-events-none"
      />
      <motion.div
        animate={{
        ...
        className="absolute bottom-1/4 left-0 w-[500px] h-[500px] bg-gradient-radial from-rose-300/15 via-transparent to-transparent blur-3xl pointer-events-none"
      />
