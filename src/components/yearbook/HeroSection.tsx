  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
        <span className="font-nunito text-[18rem] md:text-[28rem] lg:text-[35rem] font-extrabold text-foreground/[0.08] select-none leading-none">
          2025
        </span>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10 -mt-16">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="body-large text-foreground/60 max-w-2xl mx-auto mb-6 mt-4"
          >
