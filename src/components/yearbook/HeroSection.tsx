...
export function HeroSection() {
  return (
    <section
      id="cover"
      className="min-h-screen relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-navy-800 via-navy-900 to-navy-800"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="body-large text-cream-300/70 max-w-2xl mx-auto mb-12"
          >
            A celebration of what we shipped, how we grew, and the people who made it happen.
            This is our story—honest, proud, and unapologetically Netcore.
          </motion.p>
          ...
          >
            {["CE", "CPaaS", "Unbxd"].map((product, index) => (
              <motion.div
                key={product}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
